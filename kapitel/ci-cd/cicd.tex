...
\begin{lstlisting}[caption={yaml besipiel},captionpos=b, numbers=left, backgroundcolor=\color{black!10}, language=docker-compose-2]
	default:
		image: mcr.microsoft.com/dotnet/sdk:5.0
	
	variables:
		ENTRYPOINT_DLL: MyPoettinger.dll
	...
	publish_dotnet:
		...
		name: DotArtifact
		paths:
			- /builds/it-entwicklung/dotnet/mypoettinger/src/MyPoettinger.Web/bin/Release/netcoreapp3.1/publish/
		expire_in: 1 hour
		tags:
			- e
	publish_angular:
	...
	containerize:
s
e: gcr.io/kaniko-project/executor:debug
arted containerizing dotnet"
file"
MAGE:$CI_COMMIT_TAG"
PROJECT_DIR/Dockerfile
I_PROJECT_DIR/Dockerfile
DLL\"]" >> $CI_PROJECT_DIR/Dockerfile
me\":\"$CI_REGISTRY_USER\",\"password\":\"$CI_REGISTRY_PASSWORD\"}}}" > /kaniko/.docker/config.json
STRY_IMAGE:$DOCKER_IMAGE_VERSION
