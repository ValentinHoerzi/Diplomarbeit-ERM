...
\begin{lstlisting}[caption={Erste Zeilen der gitlab-ci.yml Datei},captionpos=b, numbers=left, backgroundcolor=\color{black!10}, language=yaml]
	default:
...
Nun wird das Listing 6.2 (cite) beschrieben. Bei dem \texttt{build\_dotnet} Job wird am Anfang \texttt{dotnet restore} ausgeführt, welcher mithilfe von NuGet die Abhängigkeiten des Projektes wieder herstellt. 
...
\begin{figure}[h]
	\centerline{
		\includegraphics[width=0.8\textwidth]{./grafiken/build_test_release_successful.JPG}
	}
	\vskip0pt
