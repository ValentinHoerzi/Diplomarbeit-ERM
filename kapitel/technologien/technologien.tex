...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=0.8\textwidth]{./grafiken/vs_code_startbildschirm.PNG}
	}
	\vskip0pt
...
\begin{lstlisting}[caption={C\#-Syntaxbeispiel},captionpos=b, numbers=left, backgroundcolor=\color{black!10}, breaklines=true, language={[Sharp]C}]
using System;
