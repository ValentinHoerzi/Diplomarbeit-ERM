...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=1\textwidth]{./grafiken/vs_code_startbildschirm.PNG}
	}
	\vskip0pt
...
\begin{figure}[h]
	\centerline{
	\includegraphics[width=1\textwidth]{./grafiken/visual_studio_startview.png}
	}
	\vskip0pt
...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=1\textwidth]{./grafiken/postman.png}
	}
	\vskip0pt
...
\begin{figure}[h]
	\centerline{
		\includegraphics[width=1\textwidth]{./grafiken/github_screen.png}
	}
	\vskip0pt
...
\begin{figure}[H]
	\centerline{
		\includegraphics[width=1\textwidth]{./grafiken/gitlab_startseite.JPG}
	}
	\vskip0pt
	\caption{Screenshot von GitHub}
\end{figure}
