...
{\centering
	...
	\vskip4cm
	\begin{flushleft}
		\textbf{Ausgeführt von:}\tabto{9.8cm}\textbf{Betreuer/Beteuerin:}\linebreak
		...
		Datum:\tabto{9.6cm}Betreuer/Betreuerin:
	\end{flushleft}
}
...
\IncludeSchoolTemplate{2}{
	\node at (77,-28)
		{Informatik};
	\node at (77,-80){
		\includegraphics[width=310pt,trim=0pt 0pt 0pt 0pt,clip, frame]{./grafiken/erm_home_logged_in.png}
	};
	\node at (77,-171) [text width=305]
		{Auf diesem Screenshot sieht man die Hauptseite als eingeloggter Benutzer.};
	\node at (77,-220)
		{--};
	\node at (77,-239)
...
\IncludeSchoolTemplate{4}{
	...
	\node at (77,-166) [text width=305]
		{On this screenshot you can see the main page as a logged in user.};
	\node at (77,-220)
		{--};
	\node at (77,-240)
