...
\begin{document}
	...
	% Kompile-Time with Appendix: 27.24 Sec %
	\Appendix{
		\includepdf[pages=-, scale=.70, frame=true, pagecommand={}]{./kapitel/anhang/Pflichtenheft_ERM.pdf}
	}
	% Kompile-Time without Appendix: 25.12 Sec %
