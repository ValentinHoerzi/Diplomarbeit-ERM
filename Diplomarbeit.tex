...
\lstdefinelanguage{JavaScript}{
	morekeywords=[1]{break, continue, delete, else, for, function, class, constructor, if,label,click,disabled,button, in,small,input,id,name,ngModel,change,focus,focusout,type,
